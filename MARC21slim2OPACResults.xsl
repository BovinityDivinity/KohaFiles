...
-->
        ...
        <span style="color: blue;font-weight: bold;background-color: yellow;border-radius: 5px;padding-right: 2px;padding-left: 2px;box-shadow:1px 1px 1px grey;margin-right:3px" class="title_itype">
            <xsl:value-of select="marc:datafield[@tag=942]/marc:subfield[@code='c']"></xsl:value-of>
        </span>
    <a>
